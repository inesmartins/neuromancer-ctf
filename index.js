...
http.createServer(function (req, res) {
    if (req.method === "GET") {
        ...
        res.writeHead(200, {'Content-Type': 'text/html'});
        res.end('<h1>Smuggle not found</h1><p>' + req.headers["Content-Length"] + '</p><p>' + req.headers["Transfer-Encoding"] + '</p>');
        /*
        if ((req.method === smuggleParam) || (req.headers["Content-Length"] && req.headers["Transfer-Encoding"])) {
            res.writeHead(200, {'Content-Type': 'text/html'});
